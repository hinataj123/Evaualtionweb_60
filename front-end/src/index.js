...
import Orderhistory from './components/Orders/index';
import OrderProcess from './components/Orders/orderprocess';
// VIDEO CALL PAGE
import Index from './videocall/pages/index/index.jsx';
import Meeting from './videocall/pages/meeting/index.jsx';
...
import Disease_Detection from './Farmer/DiseaseDetectionComponent';
// Features
					...
					<ScrollContext>
						<Switch>
                            ...
                            <Layout>
                                ...
                                <Route path={`${process.env.PUBLIC_URL}/farmer/disease_detection`} component={Disease_Detection}/>
								...
								{/*Routes For Video Calling*/}
                                <Route exact strict path={`${process.env.PUBLIC_URL}/videocall`} component={Index}/>
                                <Route exact strict path={`${process.env.PUBLIC_URL}/videocall/meeting`} component={Meeting}/>
                                ...
                                <Route path= {`${process.env.PUBLIC_URL}/pages/trackOrder`} component={Orderhistory}/>
                                <Route path= {`${process.env.PUBLIC_URL}/pages/orderprocess`} component={OrderProcess}/>
