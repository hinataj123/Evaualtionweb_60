...
class QuickAddVendorProduct extends Component {
    constructor(props) {
        super(props);
        this.state={
            productName:"",
    ...
    async handleSubmit(event) {
        ...
        const uploadData = new FormData();
            ...
            uploadData.append('CompanyName', this.state.ComapanyName)
                            ...
                            <div class="cad-body">
                                ...
                                <div class="input-group">
                                  ...
                                  <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <input class="input--style-1 in" type="text" placeholder="Company Name" name="cname" onChange={(e)=> this.setState({ComapanyName:e.target.value})}/>
                                    </div>
    ...
    export default QuickAddVendorProduct;