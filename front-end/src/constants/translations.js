var module = {
    ...
    en: {
        ...
        messages: {
            ...
            call_us: 'Call Us',
            welcome_note: 'Welcome to AsanKasan',
            home: 'home',
            features: 'features',
            new: 'new',
            blog: 'blog',
            ...
            shop: 'Shop',
            farmer:'Farmer',
            farmer_my_products:'My Products',
            farmer_quick_add_products:'Add Products',
            crop_prediction: 'Crop Prediction',
            disease_detection: 'Disease Detection',
            vendor:'Vendor',
            vendor_my_products:'My Products',
            vendor_quick_add_products:'Add Products',
    ...
    ur: {
        ...
        messages: {
            call_us: 'رابطہ کریں',
            welcome_note: 'آسان کسان میں خوش آمدید',
            home: 'ابتدائی صفحہ',
            shop: 'دوکان',
            category_left_sidebar: 'left sidebar',
            category_right_sidebar: 'right sidebar',
            ...
            FAQ: 'عمومی سوالات',
            farmer:'کسان',
            farmer_my_products:'میری اشیاء',
            farmer_quick_add_products:'چیزیں شامل کریں',
            crop_prediction: 'فصل کی پیشن گوئی',
            disease_detection: 'صل کی بیماری کا پتہ',
            vendor:'فروش',
            vendor_my_products:'میری اشیاء',
            vendor_quick_add_products:'چیزیں شامل کریں',
            helmets: 'helmets',
