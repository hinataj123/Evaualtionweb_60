    ...
    render (){
        ...
        return (
            <div>
                {/*SEO Support*/}
                <Helmet>
                    <title>AsanKasan | Cart List Page</title>
                                    ...
                                    {cartItems.map((item, index) => {
                                        ...
                                        <tbody key={index}>
                                            <tr>
                                                ...
                                                <td><Link to={`${process.env.PUBLIC_URL}/product/${item.id}`}>{item.productName}</Link>
                                                ...
                                                <td><h2>{symbol}{item.productPrice}</h2></td>
                                                <td>
                                                    <div className="qty-box">
                                                        <div className="input-group">
                                                ...
                                                <td>
                                                    <a href={`${process.env.PUBLIC_URL}/cart`} className="icon" onClick={() => this.props.removeFromCart(item)}>
                                                        <i className="fa fa-times"></i>
                                                    </a>
                                                </td>
                                                <td><h2 className="td-color">{symbol}{item.qty * item.productPrice}</h2></td>
                                            </tr>
                                        </tbody> )
                                    })}
                                </table>
