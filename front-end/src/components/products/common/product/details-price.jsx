...
class DetailsWithPrice extends Component {
    ...
    render() {
        ...
        const videocall = () =>{
            window.location = `${process.env.PUBLIC_URL}/videocall`
        }
        const chat = () => {
            window.location = `${process.env.PUBLIC_URL}/chat`      
         }
                            ...
                            <div className="border-product">
                                <div className="product-icon">
                                    ...
                                    <div className="btn-group" role="group">
                                        <button className="btn btn-primary" onClick={chat}><i className="fa fa-comments-o"></i> Chat</button>
                                        <button className="btn btn-success" onClick={videocall}><i className="fa fa-video-camera"></i> Video Call</button>
                                    </div>
                                </div>
                            </div>
                            :
