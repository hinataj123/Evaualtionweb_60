...
class DetailsTopTabs extends Component {
    ...
    async componentDidMount(){
        await axiosInstance.getUserProfileOfSpecificProduct(this.props.item.user)
        .then(response  => {
            if(response.status === 200){
                ...
                console.log("response from api",this.state.product)
            }
            else{
    ...
    render (){
        ...
        console.log("reviews",item.review)
        return (
