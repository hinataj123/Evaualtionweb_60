...
class NavBar extends Component {
    ...
    render() {
        ...
        return (
            <div>
            { localStorage.getItem("userInfo") !== null && localStorage.getItem("category") === 'Farmer' 
              ...
              ? 
                    ...
                    <div id="mainnav" >
                        ...
                        <ul className="nav-menu" style={this.state.navClose}>
                            ...
                            <li >
                                ...
                                <ul className="nav-submenu">
                                    <li><Link to={`${process.env.PUBLIC_URL}/farmer/products`} >{translate('farmer_my_products')}</Link></li>
                                    <li><Link to={`${process.env.PUBLIC_URL}/farmer/quickadd`} >{translate('farmer_quick_add_products')}</Link></li>
                                    <li><Link to={`#`} >{translate('crop_prediction')}</Link></li>
                                    <li><Link to={`${process.env.PUBLIC_URL}/farmer/disease_detection`} >{translate('disease_detection')}</Link></li>
                ...
                :
                localStorage.getItem("userInfo") !== null && localStorage.getItem("category") === 'Vendor' 
              ...
              <li>
                                ...
                                <ul className="nav-submenu">
                                    <li><Link to={`${process.env.PUBLIC_URL}/vendor/products`} >{translate('vendor_my_products')}</Link></li>
                                    <li><Link to={`${process.env.PUBLIC_URL}/vendor/quickadd`} >{translate('vendor_quick_add_products')}</Link></li>
                                </ul>
                            </li>
                            <li><Link to={`${process.env.PUBLIC_URL}/pages/about-us`} >{translate('about_us')}</Link></li>
                            <li><Link to={`${process.env.PUBLIC_URL}/pages/contact`} >{translate('contact')}</Link></li>
