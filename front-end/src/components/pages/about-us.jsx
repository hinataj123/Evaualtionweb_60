...
import {Slider3, Team4} from "../../services/script"
            ...
            <div>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="banner-section">
                                    <img src={'https://r-fa.bstatic.com/xdata/images/xphoto/1920x810/94265151.jpg?k=004e73dd6eb034d190633d9ec39cf2ff695ab1d2a025b4aaad239a502d73b584&o='} className="img-fluid" alt=""/>
                                </div>
                            </div>
                            <div className="col-sm-12">
                                <h4>We are making this project for the betterment of the farmers, so that people who do the most effort
                                    can make their effort worth it. </h4>
                                <p>This project permits the farmers to have a direct conversation with the customer and make a deal that
                                    comes up with good interest. Farmers are the stakeholders of this project .As they can get information 
                                    about crops. Crop will be predicted based on temperature, humidity, UV index and soil moisture values 
                                    of that area. They will get weather updates on daily basis in the form of notification. They will get 
                                    water reminders for the crop based on sensors and moisture level. The nursery farmer will buy their crop 
                                    seeds, fertilizers on an online agricultural cloud in fewer prices with no third-party interference. 
                                    Farmer will get disease detection on their crop leaf by using image processing and they will be able to 
                                    control these diseases.</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="testimonial small-section">
                    ...
                    <div className="col-sm-12">
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <Slider {...Slider3} className="slide-3 testimonial-slider no-arrow">
                                <div>
                                    <div className="media">
                                        <div className="text-center">
                                            <img src={`${process.env.PUBLIC_URL}/assets/images/suleman.jpg`} style={{resize:"contain"}}  alt="#"  />
                                                <h5>Muhammad Suleman</h5>
                                                <h6>Designer</h6>
                                        </div>
                                    ...
                                    <div>
                                        <div className="media">
                                            <div className="text-center">
                                                <img src={`${process.env.PUBLIC_URL}/assets/images/hina.jpeg`} alt="#" />
                                                    <h5>Hina Tajammal</h5>
                                                    <h6>Designer</h6>
                                            </div>
                                            <div className="media-body">
                                    ...
                                    <div>
                                        <div className="media">
                                            <div className="text-center">
                                                <img src={`${process.env.PUBLIC_URL}/assets/images/hamza.jpg`} alt="#" />
                                                    <h5>Hamza Iftikhar</h5>
                                                    <h6>Designer</h6>
                                            </div>
                                            <div className="media-body">
